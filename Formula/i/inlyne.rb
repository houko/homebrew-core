class Inlyne < Formula
  ...
  test do
    ...
    if OS.linux? && ENV["HOMEBREW_GITHUB_ACTIONS"]
      ...
      # Could use `fontconfig` in test after https://github.com/Homebrew/homebrew-core/pull/290353
      ENV["FONTCONFIG_FILE"] = testpath/"fonts.conf"
      (testpath/"fonts.conf").write <<~XML
        <?xml version="1.0"?>
